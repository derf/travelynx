...
Also, note that “AI” (as in, Large Language Models / LLMs such as ChatGPT, Claude, Copilot, Cursor, Grok, etc.) may not be used to generate code (or other artefacts) for contributions to this project.
