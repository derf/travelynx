...
my %valid_train_type = map { $_ => 1 } qw(
  ...
  RE IRE REX REGIONAL_FAST_RAIL CJX RB MEX TER R REGIONAL_RAIL Regionalzug R-Bahn
  BRB ECD IC ICE EC ECE D IR TGV OGV EST FR TLK EIC EIP EUR HIGHSPEED_RAIL
